...
{*******************************************************************************}
  ...
  protected
    ...
    procedure DoContextMenuAfterCmd(Namespace: TNamespace; Verb: WideString;
        MenuItemID: Integer; Successful: Boolean); virtual;
    function DoContextMenuCmd(Namespace: TNamespace; Verb: WideString; MenuItemID:
        Integer): Boolean; virtual;
    procedure DoContextMenuSelect(Namespace: TNamespace; MenuItemID : Integer;
        SubMenuID: hMenu; MouseSelect: Boolean); virtual;
    ...
    procedure DoEnumThreadLengthyOperation(var ShowAnimation: Boolean); virtual;
    ...
    procedure DoGetVETText(Column: TColumnIndex; Node: PVirtualNode; Namespace:
        TNamespace; var Text: UnicodeString); virtual;
    ...
    function EnumerateFolderCallback(MessageWnd: HWnd; APIDL: PItemIDList; AParent:
        TNamespace; Data: pointer; var Terminate: Boolean): Boolean; virtual;
    function ExpandNamespaceFolder(Node: PVirtualNode): integer; virtual;
    function FindFolderByNameCallback(MessageWnd: HWnd; APIDL: PItemIDList;
        AParent: TNamespace; Data: Pointer; var Terminate: Boolean): Boolean;
        virtual;
    procedure ForceIconCachRebuild; virtual;
    ...
    procedure HideAnimateFolderWnd; virtual;
...
procedure TCustomVirtualExplorerTree.DoContextMenuAfterCmd(Namespace:
...
function TCustomVirtualExplorerTree.DoContextMenuCmd(Namespace: TNamespace;
    Verb: WideString; MenuItemID: Integer): Boolean;
begin
  Result := False;
...
procedure TCustomVirtualExplorerTree.DoContextMenuSelect(Namespace: TNamespace;
...
function TCustomVirtualExplorerTree.DoContextMenuShow(Namespace: TNamespace;
    Menu: hMenu): Boolean;
begin
  Result := True;
...
procedure TCustomVirtualExplorerTree.DoEnumThreadLengthyOperation(var
...
procedure TCustomVirtualExplorerTree.DoGetVETText(Column: TColumnIndex; Node:
    PVirtualNode; Namespace: TNamespace; var Text: UnicodeString);
begin
...
function TCustomVirtualExplorerTree.EnumerateFolderCallback(MessageWnd: HWnd;
    APIDL: PItemIDList; AParent: TNamespace; Data: pointer; var Terminate:
    Boolean): Boolean;
