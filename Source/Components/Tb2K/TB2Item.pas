...
begin
  ...
  if assigned(FSubMenuImagesChangeLink) then
  FreeAndNil(FSubMenuImagesChangeLink);
  if assigned(FImagesChangeLink) then
...
var
  ...
  CalcCanvas: TCanvas;
  // CubicExplorer EDIT!!! Show all separators
  //LastWasSep,
  LastWasButton, IsButton, IsControl: Boolean;
  Item: TTBCustomItem;
  Ctl: TControl;
  ChangedBold: Boolean;
