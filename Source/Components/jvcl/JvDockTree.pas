...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDockTree.pas 11755 2008-03-10 17:03:24Z ahuser $
...
type
  ...
  private
   ...
   protected
    ...
    procedure ShowControl(Control: TControl);
    procedure HideControl(Control: TControl); virtual;
    procedure ShowAllControl;
    procedure HideAllControl;
    procedure ShowSingleControl(Control: TControl);
    procedure HideSingleControl(Control: TControl);
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_34_PREPARATION/run/JvDockTree.pas $';
