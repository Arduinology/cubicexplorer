...
// Modified some parts to support Unicode paths, by Marko Savolainen.

unit JclCompressionWide;
...
type
  ...
  public
    ...
    function FindCompressFormat(const AFileName: WideString): TJclCompressStreamClass;
    function FindDecompressFormat(const AFileName: WideString): TJclDecompressStreamClass;
...
type
  ...
  public
    ...
    property OriginalFileName: WideString read FOriginalFileName write FOriginalFileName;
...
function GZipFile(SourceFile, DestinationFile: WideString; CompressionLevel: Integer = Z_DEFAULT_COMPRESSION;
  ProgressCallback: TJclCompressStreamProgressCallback = nil; UserData: Pointer = nil): Boolean;
function UnGZipFile(SourceFile, DestinationFile: WideString;
  ProgressCallback: TJclCompressStreamProgressCallback = nil; UserData: Pointer = nil): Boolean;
...
function BZip2File(SourceFile, DestinationFile: WideString; CompressionLevel: Integer = 5;
  ProgressCallback: TJclCompressStreamProgressCallback = nil; UserData: Pointer = nil): Boolean;
function UnBZip2File(SourceFile, DestinationFile: WideString;
  ProgressCallback: TJclCompressStreamProgressCallback = nil; UserData: Pointer = nil): Boolean;
...
type
  TJclCompressionVolumeEvent = procedure(Sender: TObject; Index: Integer;
    var AFileName: WideString; var AStream: TStream; var AOwnsStream: Boolean) of object;
  ...
  public
    constructor Create(AStream, ATmpStream: TStream; AOwnsStream, AOwnsTmpStream: Boolean;
      AFileName, ATmpFileName: WideString; AVolumeMaxSize: Int64);
    destructor Destroy; override;
    procedure ReleaseStreams;
    property FileName: WideString read FFileName;
    property TmpFileName: WideString read FTmpFileName;
  ...
  private
    ...
    FVolumeMaxSize: Int64;
    FVolumeFileNameMask: WideString;
    FProgressMax: Int64;
  ...
  protected
    ...
    function InternalOpenStream(const FileName: WideString): TStream;
  ...
  public
    ...
    constructor Create(const VolumeFileName: WideString; AVolumeMaxSize: Int64 = 0;
    ...
    function AddVolume(const VolumeFileName: WideString;
      AVolumeMaxSize: Int64 = 0): Integer; overload; virtual;
    function AddVolume(const VolumeFileName, TmpVolumeFileName: WideString;
      AVolumeMaxSize: Int64 = 0): Integer; overload; virtual;
    ...
    property VolumeMaxSize: Int64 read FVolumeMaxSize;
    property VolumeFileNameMask: WideString read FVolumeFileNameMask;
  ...
  private
    ...
    FBaseDirName: WideString;
    FAddFilesInDir: Boolean;
    FDuplicateAction: TJclCompressionDuplicateAction;
    FDuplicateCheck: TJclCompressionDuplicateCheck;
    procedure InternalAddFile(const Directory: WideString; const FileInfo:
        TSearchRecW);
    procedure InternalAddDirectory(const Directory: WideString);
  protected
  ...
  public
    ...
    function AddFile(const PackedName: WideString; const FileName: WideString):
  ...
  TJclCompressionExtractEvent = function (Sender: TObject; Index: Integer;
    var FileName: WideString; var Stream: TStream; var AOwnsStream: Boolean): Boolean of object;
  ...
  protected
    ...
    function ValidateExtraction(Index: Integer; var FileName: WideString; var
        AStream: TStream; var AOwnsStream: Boolean): Boolean; virtual;
  public
    class function VolumeAccess: TJclStreamAccess; override;
    class function ItemAccess: TJclStreamAccess; override;

    procedure ListFiles; virtual; abstract;
    procedure ExtractSelected(const ADestinationDir: WideString; AAutoCreateSubDir:
        Boolean); virtual;
    procedure ExtractAll(const ADestinationDir: WideString; AAutoCreateSubDir:
        Boolean); virtual;

    property OnExtract: TJclCompressionExtractEvent read FOnExtract write FOnExtract;
    property DestinationDir: WideString read fDestinationDir;
  ...
  public
    ...
    procedure ListFiles; virtual; abstract;
    procedure ExtractSelected(const ADestinationDir: WideString = '';
      AAutoCreateSubDir: Boolean = True); virtual;
    procedure ExtractAll(const ADestinationDir: WideString = '';
      AAutoCreateSubDir: Boolean = True); virtual;
  ...
  TJclCompressionReplaceEvent = function (Sender: TObject; const SrcFileName, DestFileName: WideString;
  ...
  protected
    ...
    function InternalOpenTmpStream(const FileName: WideString): TStream;
  public
...
type
  ...
  public
    ...
    function FindCompressFormat(const AFileName: WideString): TJclCompressArchiveClass;
    function FindDecompressFormat(const AFileName: WideString): TJclDecompressArchiveClass;
    function FindUpdateFormat(const AFileName: WideString): TJclUpdateArchiveClass;
...
function Create7zFile(SourceFiles: TStrings; const DestinationFile: WideString; VolumeSize: Int64 = 0; Password: String
    = ''; OnArchiveProgress: TJclCompressionProgressEvent = nil): Boolean; overload;
function Create7zFile(const SourceFile, DestinationFile: WideString; VolumeSize: Int64 = 0; Password: String = '';
    OnArchiveProgress: TJclCompressionProgressEvent = nil): Boolean; overload;

function WideFindUnusedFileName(FileName: WideString; const FileExt:
    WideString; NumberPrefix: WideString = ''): WideString;

function WidePathAddExtension(const Path, Extension: WideString): WideString;

function WideStrEnsurePrefix(const Prefix, Text: WideString): WideString;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jcl.svn.sourceforge.net:443/svnroot/jcl/tags/JCL-2.2-Build3970/jcl/source/common/JclCompression.pas $';
...
function TJclCompressionStreamFormats.FindCompressFormat(const AFileName: WideString): TJclCompressStreamClass;
var
...
function TJclCompressionStreamFormats.FindDecompressFormat(const AFileName: WideString): TJclDecompressStreamClass;
var
  IndexFormat, IndexFilter: Integer;
  Filters: TStrings;
...
begin
  ...
  if (FHeader.Flags and JCL_GZIP_FLAG_NAME) <> 0 then
    FOriginalFileName := WideString(ReadCString);
...
function GZipFile(SourceFile, DestinationFile: WideString; CompressionLevel: Integer;
  ProgressCallback: TJclCompressStreamProgressCallback; UserData: Pointer): Boolean;
var
  GZipStream: TJclGZIPCompressionStream;
  DestStream: TTntFileStream;
  SourceStream: TTntFileStream;
...
begin
  ...
  SourceStream := TTntFileStream.Create(SourceFile, fmOpenRead or fmShareDenyWrite);
  try
    DestStream := TTntFileStream.Create(DestinationFile, fmCreate); // see SysUtils
    try
...
begin
  ...
  {destination and source streams first and second}
  SourceStream := TTntFileStream.Create(SourceFile, {mode} fmOpenRead or fmShareDenyWrite);
  try
    DestStream := TTntFileStream.Create(DestinationFile, {mode} fmCreate); // see SysUtils
    try
...
function BZip2File(SourceFile, DestinationFile: WideString; CompressionLevel: Integer;
  ProgressCallback: TJclCompressStreamProgressCallback; UserData: Pointer): Boolean;
var
...
function OpenFileStream(const FileName: WideString; StreamAccess: TJclStreamAccess): TStream;
begin
  Result := nil;
  case StreamAccess of
    saCreate:
      Result := TTntFileStream.Create(FileName, fmCreate);
    saReadOnly:
      if WideFileExists(FileName) then
        Result := TTntFileStream.Create(FileName, fmOpenRead or fmShareDenyWrite);
    saReadOnlyDenyNone:
      if WideFileExists(FileName) then
        Result := TTntFileStream.Create(FileName, fmOpenRead or fmShareDenyNone);
    saWriteOnly:
      if WideFileExists(FileName) then
        Result := TTntFileStream.Create(FileName, fmOpenWrite)
      else
      if FileName <> '' then
        Result := TTntFileStream.Create(FileName, fmCreate);
    saReadWrite:
      if WideFileExists(FileName) then
        Result := TTntFileStream.Create(FileName, fmOpenReadWrite)
      else
      if FileName <> '' then
        Result := TTntFileStream.Create(FileName, fmCreate);
  end;
...
function TJclCompressionItem.GetFileName: WideString;
begin
...
procedure TJclCompressionItem.SetFileName(const Value: WideString);
var
...
begin
  ...
  if (Value <> '') and (FArchive is TJclCompressionArchive) then
  begin
    if Win32PlatformIsUnicode then
    b:= GetFileAttributesExW(PWideChar(Value), GetFileExInfoStandard, @AFindData)
    else
    b:= GetFileAttributesEx(PChar(String(Value)), GetFileExInfoStandard, @AFindData);
...
begin
  ...
  if Kind = ikDirectory then
  Result:= WideDirectoryExists(FFileName);

  if Result then
  begin
    FileHandle := Tnt_CreateFileW(PWideChar(FFileName), FILE_WRITE_ATTRIBUTES, FILE_SHARE_READ, nil, OPEN_ALWAYS, 0, 0);
    try
...
function TJclCompressionArchiveFormats.FindCompressFormat(const AFileName: WideString): TJclCompressArchiveClass;
var
  IndexFormat, IndexFilter: Integer;
  Filters: TStrings;
...
function TJclCompressionArchiveFormats.FindDecompressFormat(const AFileName: WideString): TJclDecompressArchiveClass;
var
  IndexFormat, IndexFilter: Integer;
  Filters: TStrings;
...
function TJclCompressionArchiveFormats.FindUpdateFormat(const AFileName: WideString): TJclUpdateArchiveClass;
var
  IndexFormat, IndexFilter: Integer;
  Filters: TStrings;
...
constructor TJclCompressionArchive.Create(const VolumeFileName: WideString;
...
function TJclCompressionArchive.AddVolume(const VolumeFileName: WideString;
...
function TJclCompressionArchive.AddVolume(const VolumeFileName, TmpVolumeFileName: WideString;
  AVolumeMaxSize: Int64): Integer;
begin
...
function TJclCompressionArchive.InternalOpenStream(
  const FileName: WideString): TStream;
begin
...
begin
  ...
  begin
    ...
    AVolume := nil;
    AFileName := WideFormat(VolumeFileNameMask, [Index + VolumeIndexOffset]);
    ...
    begin
      while FVolumes.Count < Index do
        FVolumes.Add(TJclCompressionVolume.Create(nil, nil, True, True, WideFormat(VolumeFileNameMask, [Index + VolumeIndexOffset]), '', FVolumeMaxSize));
      if not Assigned(Result) then
        Result := InternalOpenStream(AFileName);
...
function TJclCompressArchive.AddDirectory(const PackedName: WideString; const
    DirName: WideString = ''; RecurseIntoDir: Boolean = False; AddFilesInDir:
    Boolean = False): Integer;

  procedure ProcessDir(ADir: WideString);
  var
    sr: TSearchRecW;
  begin
    InternalAddDirectory(ADir);
    if WideFindFirst(ADir + '*', faDirectory or faHidden, sr) = S_OK then
    begin
      try
        repeat
          if (sr.Name <> '.') and (sr.Name <> '..') and (sr.Attr and faDirectory <> 0) then
          begin
            ProcessDir(ADir + sr.Name  + '\');
          end;
  ...
  procedure ProcessFiles(APath: WideString);
  var
    sr: TSearchRecW;
  begin
    if WideFindFirst(APath, faAnyFile and not faDirectory, sr) = S_OK then
    begin
      try
        repeat
          if (sr.Attr and faDirectory = 0) or (sr.Name <> '.') and (sr.Name <> '..') then
          begin
            InternalAddFile(DirName, sr);
          end;
        until WideFindNext(sr) <> S_OK;
      finally
        WideFindClose(sr);
...
begin
  ...
  begin
    ...
    FBaseDirName := WideExcludeTrailingPathDelimiter(DirName);
    FAddFilesInDir := AddFilesInDir;

    if RecurseIntoDir then
    begin
      Result:= FItems.Count;
      ProcessDir(WideIncludeTrailingPathDelimiter(DirName));
      Exit;
    end;
  end;
  ...
  ProcessFiles(WideIncludeTrailingBackslash(DirName));
end;

function TJclCompressArchive.AddFile(const PackedName: WideString; const
...
procedure TJclCompressArchive.InternalAddDirectory(const Directory: WideString);
begin
  AddDirectory(TranslateItemPath(Directory, FBaseDirName, FBaseRelName), Directory, False, FAddFilesInDir);
end;

procedure TJclCompressArchive.InternalAddFile(const Directory: WideString;
    const FileInfo: TSearchRecW);
var
  AFileName: WideString;
  AItem: TJclCompressionItem;
begin
  AFileName := WideIncludeTrailingPathDelimiter(Directory) + FileInfo.Name;
...
procedure TJclDecompressArchive.ExtractAll(const ADestinationDir: WideString;
...
procedure TJclDecompressArchive.ExtractSelected(const ADestinationDir: WideString;
  AAutoCreateSubDir: Boolean);
begin
// Calling ReleaseVolumes here causes subsequent operations on the archive to fail with an "unsupported method" exception
//  ReleaseVolumes;
...
function TJclDecompressArchive.ValidateExtraction(Index: Integer; var FileName:
    WideString; var AStream: TStream; var AOwnsStream: Boolean): Boolean;
var
  AItem: TJclCompressionItem;
...
begin
  ...
  begin
    ...
    if PackedName = '' then
      PackedName := WideChangeFileExt(WideExtractFileName(Volumes[0].FileName), AItem.PackedExtension);

    FileName:= WideIncludeTrailingPathDelimiter(FDestinationDir) + PackedName; //PathGetRelativePath(FDestinationDir, PackedName);
  end;
  Result := True;
...
constructor TJclUpdateArchive.Create(const VolumeFileName: WideString; AVolumeMaxSize: Int64; VolumeMask: Boolean);
begin
  inherited Create(VolumeFileName, AVolumeMaxSize, VolumeMask);
  FDuplicateCheck := dcExisting;
end;

procedure TJclUpdateArchive.ExtractAll(const ADestinationDir: WideString = '';
    AAutoCreateSubDir: Boolean = True);
begin
// Calling ReleaseVolumes here causes subsequent operations on the archive to fail with an "unsupported method" exception
//  ReleaseVolumes;
end;

procedure TJclUpdateArchive.ExtractSelected(const ADestinationDir: WideString =
    ''; AAutoCreateSubDir: Boolean = True);
begin
// Calling ReleaseVolumes here causes subsequent operations on the archive to fail with an "unsupported method" exception
//  ReleaseVolumes;
...
function TJclUpdateArchive.ValidateExtraction(Index: Integer; var FileName:
    WideString; var AStream: TStream; var AOwnsStream: Boolean): Boolean;
var
  AItem: TJclCompressionItem;
  PackedName: WideString;
...
var
  Index: Integer;
  AVolume: TJclCompressionVolume;
  SrcFileName, DestFileName: WideString;
...
constructor TJclOutOfPlaceUpdateArchive.Create(const VolumeFileName: WideString;
...
begin
  ...
  begin
    AOwnsStream := VolumeFileNameMask <> '';
    AVolume := nil;
    AFileName := WideFindUnusedFileName(WideFormat(VolumeFileNameMask, [Index + VolumeIndexOffset]), '.tmp');
    if (Index >= 0) and (Index < FVolumes.Count) then
    begin
      AVolume := TJclCompressionVolume(FVolumes.Items[Index]);
      ...
      if AFileName = '' then
        AFileName := WideFindUnusedFileName(AVolume.FileName, '.tmp');
    end;
...
var
  I: Integer;
begin
  Result:= WidePathAddExtension(FileName, FileExt);
  if not WideFileExists(Result) then
    Exit;
  if WideSameText(Result, FileName) then
    Delete(FileName, Length(FileName) - Length(FileExt) + 1, Length(FileExt));
  I := 0;
  repeat
    Inc(I);
    Result:= WidePathAddExtension(FileName + NumberPrefix + IntToStr(I), FileExt);
...
begin
  ...
  if (Path <> '') and (Extension <> '') and
    not WideSameText(WideExtractFileExt(Path), WideStrEnsurePrefix('.', Extension)) then
  begin
...
procedure TJclSevenzipDecompressArchive.ExtractAll(const ADestinationDir: WideString;
  AAutoCreateSubDir: Boolean);
var
...
begin
  ...
  if FDestinationDir <> '' then
    FDestinationDir:= WideIncludeTrailingPathDelimiter(FDestinationDir);
...
procedure TJclSevenzipDecompressArchive.ExtractSelected(const ADestinationDir: WideString;
  AAutoCreateSubDir: Boolean);
var
  AExtractCallback: IArchiveExtractCallback;
  Indices: array of Cardinal;
...
procedure TJclSevenzipUpdateArchive.ExtractAll(const ADestinationDir:
    WideString = ''; AAutoCreateSubDir: Boolean = True);
var
  AExtractCallback: IArchiveExtractCallback;
  Indices: array of Cardinal;
  NbIndices: Cardinal;
...
procedure TJclSevenzipUpdateArchive.ExtractSelected(const ADestinationDir:
    WideString = ''; AAutoCreateSubDir: Boolean = True);
var
  AExtractCallback: IArchiveExtractCallback;
  Indices: array of Cardinal;
